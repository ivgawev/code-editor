import{s as d,j as i,r as c,$ as w,a as p,R as y,t as $,f as M}from"./index.f9dd7362.js";var P=d.button`
...
`;const C=c.exports.createContext({});function O(){return w(C)}const L=d.section`
      display: flex;
      flex-direction: column;
...
`,re=()=>p(te,{children:[i("img",{src:"https://freesvg.org/img/claudita-Flag-of-Spain.png"}),i(g,{variant:"secondary",children:"Code Editor"})]}),ne=({children:e})=>{const[t,r]=c.exports.useState([]),n=c.exports.useCallback(s=>{t.includes(s)||r(l=>[...l,s])},[]),o=c.exports.useMemo(()=>F(t),[t]),a=c.exports.useMemo(()=>({pathsTree:o,addPath:n}),[o]);return i(C.Provider,{value:a,children:e})},ie=()=>p(S,{children:[i(re,{}),p(ne,{children:[i(ee,{}),i(j,{})]})]});export{ie as default};
