import{s as d,j as i,r as a,a as m,$ as z,R as y,t as $,f as M}from"./index.ffcf3ef4.js";var P=d.button`
...
`,b=d.div`
      flex: ${({weight:e})=>e};
`;const C=a.exports.createContext({});function O(){return z(C)}const T=d.section`
      display: flex;
      flex-direction: column;
...
`,q=({icon:e,name:t,showChildren:r,...n})=>m(X,{showChildren:r,...n,children:[e,i(g,{children:t})]}),Q=a.exports.memo(q),Z=({id:e,name:t,file:r,showChildren:n,setShowChildren:o,...l})=>{const{selected:s,setSelected:c}=re(),h=a.exports.useCallback(()=>{o(f=>!f),c(e)},[]),{icon:v,color:x}=K(r!=null?r:n?"folderOpen":"folder");return i(Q,{id:e,name:t,file:r,icon:i(v,{color:x}),selected:s===e,showChildren:n,onClick:h,...l},t)},ee=d.aside`
      flex: 1;
      height: 100vh;
...
`;function te(){return{render:a.exports.useCallback(({node:t,...r})=>{var f;const{id:n,level:o,children:l}=t,c=(f=n.split("/").at(-1))!=null?f:"",h=c.split(".")[1],v=l.length>0,x={id:n,name:c,level:o,file:h,hasChildren:v,...r};return i(Z,{...x})},[])}}const I=a.exports.createContext({});function re(){return z(I)}const ne=()=>{const{pathsTree:e}=O(),{render:t}=te(),[r,n]=a.exports.useState(""),o=a.exports.useMemo(()=>({selected:r,setSelected:n}),[r]);return i(ee,{children:i(I.Provider,{value:o,children:i(M,{tree:e,render:t})})})},oe=d.header`
      display: flex;
      align-items: center;
      gap: ${({theme:e})=>e.units[2]}rem;
...
`,ie=()=>m(oe,{children:[i("img",{src:"https://freesvg.org/img/claudita-Flag-of-Spain.png"}),i(g,{variant:"secondary",children:"Code Editor"})]}),le=({children:e})=>{const[t,r]=a.exports.useState([]),n=a.exports.useCallback(s=>{t.includes(s)||r(c=>[...c,s])},[]),o=a.exports.useMemo(()=>j(t),[t]),l=a.exports.useMemo(()=>({pathsTree:o,addPath:n}),[o]);return i(C.Provider,{value:l,children:e})},ce=()=>m(L,{children:[i(ie,{}),i(le,{children:m(F,{size:{left:1,right:3},children:[i(ne,{}),i(B,{})]})})]});export{ce as default};
